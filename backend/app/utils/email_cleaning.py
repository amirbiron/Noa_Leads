...
#
# גבולות הטווח נכתבים כ-escapes ולא כתווים: U+200B..U+200F הם בלתי
# נראים בכל עורך, כלומר בצורה הקודמת הטווח היה `[\s?-?]` — אי אפשר
# לקרוא אותו, אי אפשר לבדוק אותו בעין, ו-bandit (B613) ו-ruff
# (PLE2502) פוסלים תווי BiDi בקוד מקור. השקילות אומתה על כל התווים
# בטווח ועל מקרי הקצה.
