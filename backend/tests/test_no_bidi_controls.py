...
- `bandit` פוסל אותם ב-`B613`, ו-`ruff` ב-`PLE2502`. הכלים מחמירים
  בצדק — תו BiDi יכול לגרום לקוד להיראות אחרת ממה שהמהדר קורא, וזו
  טכניקת התקפה אמיתית (Trojan Source, CVE-2021-42574). בהערות עברית
  זה תמים לגמרי, אבל הכלי אינו יכול להבחין.
